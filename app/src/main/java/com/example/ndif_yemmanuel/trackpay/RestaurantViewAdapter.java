...
public class RestaurantViewAdapter extends BaseAdapter {
    ...
    public RestaurantViewAdapter(Context context, ArrayList<String> name, ArrayList<String> address, ArrayList<String> open,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflaInflater.inflate(R.layout.list_restaurant, parent, false);
        }
