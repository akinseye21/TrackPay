...
public class MdaProfile extends AppCompatActivity {
    ...
    public static final String UPDATE_PROFILE = "http://arrearskdsg.com.ng/mobile/mdaupdate";
...
//                        break;
//                    case R.id.help:
//                        Intent j = new Intent(MdaProfile.this, HelpDesk.class);
...
//                        break;
//                    case R.id.profile:
////                        Intent j = new Intent(MdaProfile.this, VendorProfile.class);
////                        startActivity(j);
//                        break;
                    default:
