            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.signout:
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(MdaDashboard.this);
                        builder.setTitle("Exit");
                        builder.setMessage("Do you want to exit Trackpay?");

                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i = new Intent(MdaDashboard.this,  MainActivity.class);
                                startActivity(i);
                                dialog.dismiss();
                            }
                        });
                        ...
                        break;
                    case R.id.chat:
                        Intent i = new Intent(MdaDashboard.this,  LiveChat.class);
                        startActivity(i);
                        break;
