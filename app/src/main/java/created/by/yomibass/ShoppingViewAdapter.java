...
public class ShoppingViewAdapter extends BaseAdapter {
    ...
    public ShoppingViewAdapter(Context context, ArrayList<String> name, ArrayList<String> address, ArrayList<String> open,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflaInflater.inflate(R.layout.list_shopping, parent, false);
        }
