...
public class ShoppingCentresToVisit extends AppCompatActivity {

    public static final String SHOPPING_TO_VISIT = "https://arrearskdsg.com.ng/mobile/shoppingcenters";
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.signout:
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(ShoppingCentresToVisit.this);
                        builder.setTitle("Exit");
                        builder.setMessage("Do you want to exit Trackpay?");

                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i = new Intent(ShoppingCentresToVisit.this,  MainActivity.class);
                                startActivity(i);
                                dialog.dismiss();
                            }
                        });
                        ...
                        break;
                    case R.id.chat:
                        Intent i = new Intent(ShoppingCentresToVisit.this,  LiveChat.class);
                        startActivity(i);
                        break;
...
//                        startActivity(j);
        ...
        //get JSON's from API
        StringRequest stringRequest = new StringRequest(Request.Method.POST, SHOPPING_TO_VISIT,
...
//                            System.out.println("Array name = "+Array_name);
                            ...
                            ShoppingViewAdapter shoppingViewAdapter = new ShoppingViewAdapter(getApplicationContext(), Array_name, Array_address, Array_opens, Array_closes, Array_image, Array_contact);
                            listview.setAdapter(shoppingViewAdapter);
...
//
                                    Intent intent = new Intent(ShoppingCentresToVisit.this, RestaurantView.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(ShoppingCentresToVisit.this, e.getMessage(), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(ShoppingCentresToVisit.this, "Error loading restaurants", Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ShoppingCentresToVisit.this);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (code.equals("vendor")){
                    ...
                    Toast.makeText(ShoppingCentresToVisit.this, "Register or Login to access", Toast.LENGTH_LONG).show();
                }
